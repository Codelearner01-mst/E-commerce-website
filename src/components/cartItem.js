...
export function CartItem(cart, path) {
  ...
  cartDiv.innerHTML = `
    ...
    <div class="flex items-center gap-6.5">
      <div class="flex items-center rounded-sm w-max h-9 overflow-hidden cart-btns-box">
        <button class="decrease-btn w-9 h-full flex items-center justify-center bg-yellow-700  text-white  hover:bg-yellow-600 hover:text-white transition-colors duration-300 text-xl font-light focus:outline-none cursor-pointer">&#8722;</button>
        ...
        <button class="increase-btn w-9 h-full flex items-center justify-center bg-yellow-700  text-white hover:bg-yellow-600 hover:text-white transition-colors duration-300 text-xl font-light focus:outline-none cursor-pointer">&#43;</button>
      </div>
      <div>
